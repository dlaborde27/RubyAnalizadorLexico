...
_lr_productions = [
  ...
  ('hash_declaration -> HASH LEFT_COR values RIGHT_COR','hash_declaration',4,'p_hash_declaration','analizador_sintactico.py',157),
  ('hash_declaration -> HASH LEFT_COR RIGHT_COR','hash_declaration',3,'p_hash_declaration','analizador_sintactico.py',158),
  ('hash_access -> variable LEFT_COR value RIGHT_COR','hash_access',4,'p_hash_access','analizador_sintactico.py',162),
  ('hash_operations -> hash_access ASSIGN value','hash_operations',3,'p_hash_operations','analizador_sintactico.py',166),
  ('while_statement -> WHILE condiciones COLON codigo','while_statement',4,'p_while_statement','analizador_sintactico.py',173),
  ('print_statement -> PUTS LEFT_PAR values RIGHT_PAR','print_statement',4,'p_print_statement','analizador_sintactico.py',179),
  ('boolean_expression -> expression GREATER_THAN expression','boolean_expression',3,'p_boolean_expression','analizador_sintactico.py',184),
  ('boolean_expression -> expression LESS_THAN expression','boolean_expression',3,'p_boolean_expression','analizador_sintactico.py',185),
  ('boolean_expression -> expression GREATER_THAN_EQUAL expression','boolean_expression',3,'p_boolean_expression','analizador_sintactico.py',186),
  ('boolean_expression -> expression LESS_THAN_EQUAL expression','boolean_expression',3,'p_boolean_expression','analizador_sintactico.py',187),
  ('boolean_expression -> expression EQUAL expression','boolean_expression',3,'p_boolean_expression','analizador_sintactico.py',188),
  ('boolean_expression -> expression NOT_EQUAL expression','boolean_expression',3,'p_boolean_expression','analizador_sintactico.py',189),
  ('boolean_expression -> BOOLEAN','boolean_expression',1,'p_boolean_expression','analizador_sintactico.py',190),
  ('expression -> INTEGER','expression',1,'p_expression','analizador_sintactico.py',193),
  ('expression -> FLOAT','expression',1,'p_expression','analizador_sintactico.py',194),
  ('expression -> variable','expression',1,'p_expression','analizador_sintactico.py',195),
  ('expression -> STRING','expression',1,'p_expression','analizador_sintactico.py',196),
  ('declaraciones -> declaracion_variable','declaraciones',1,'p_declaraciones','analizador_sintactico.py',200),
  ('declaraciones -> almacenar_resultado_condicional','declaraciones',1,'p_declaraciones','analizador_sintactico.py',201),
  ('declaraciones -> declaracion_estructura_datos','declaraciones',1,'p_declaraciones','analizador_sintactico.py',202),
  ('expresion -> puts','expresion',1,'p_expresion','analizador_sintactico.py',207),
  ('expresion -> gets','expresion',1,'p_expresion','analizador_sintactico.py',208),
  ('expresion -> print_statement','expresion',1,'p_expresion','analizador_sintactico.py',209),
  ('set_expression -> SET DOT NEW LEFT_PAR LEFT_COR values RIGHT_COR RIGHT_PAR','set_expression',8,'p_set_expression','analizador_sintactico.py',214),
  ('set_expression -> SET LEFT_COR values RIGHT_COR','set_expression',4,'p_set_expression','analizador_sintactico.py',215),
  ('set_operations -> set_expression','set_operations',1,'p_set_operations','analizador_sintactico.py',218),
  ('set_operations -> set_operations set_binary_operators set_expression','set_operations',3,'p_set_operations','analizador_sintactico.py',219),
  ('declaracion_estructura_datos -> LOCAL_VARIABLE ASSIGN set_expression','declaracion_estructura_datos',3,'p_set_declaration','analizador_sintactico.py',222),
  ('set_binary_operators -> PLUS','set_binary_operators',1,'p_set_binary_operators','analizador_sintactico.py',225),
  ('set_binary_operators -> MINUS','set_binary_operators',1,'p_set_binary_operators','analizador_sintactico.py',226),
  ('set_binary_operators -> AMPERSAND','set_binary_operators',1,'p_set_binary_operators','analizador_sintactico.py',227),
  ('set_binary_operators -> PIPE','set_binary_operators',1,'p_set_binary_operators','analizador_sintactico.py',228),
  ('set_binary_operators -> CARET','set_binary_operators',1,'p_set_binary_operators','analizador_sintactico.py',229),
  ('unless_expression -> UNLESS boolean_expression THEN expresion END','unless_expression',5,'p_unless_expression','analizador_sintactico.py',232),
  ('unless_expression -> UNLESS boolean_expression THEN expresion ELSE expresion END','unless_expression',7,'p_unless_expression','analizador_sintactico.py',233),
  ('expresion -> arithmetic_production','expresion',1,'p_arithmetic_expression','analizador_sintactico.py',236),
  ('arithmetic_production -> numero','arithmetic_production',1,'p_arithmetic_production','analizador_sintactico.py',239),
  ('arithmetic_production -> variable','arithmetic_production',1,'p_arithmetic_production','analizador_sintactico.py',240),
  ('arithmetic_production -> numero arithmetic_operators arithmetic_production','arithmetic_production',3,'p_arithmetic_production','analizador_sintactico.py',241),
  ('arithmetic_production -> variable arithmetic_operators arithmetic_production','arithmetic_production',3,'p_arithmetic_production','analizador_sintactico.py',242),
  ('arithmetic_operators -> PLUS','arithmetic_operators',1,'p_arithmetic_operators','analizador_sintactico.py',245),
  ('arithmetic_operators -> MINUS','arithmetic_operators',1,'p_arithmetic_operators','analizador_sintactico.py',246),
  ('arithmetic_operators -> MULTIPLY','arithmetic_operators',1,'p_arithmetic_operators','analizador_sintactico.py',247),
  ('arithmetic_operators -> DIVIDE','arithmetic_operators',1,'p_arithmetic_operators','analizador_sintactico.py',248),
  ('arithmetic_operators -> MODULO','arithmetic_operators',1,'p_arithmetic_operators','analizador_sintactico.py',249),
  ('arithmetic_operators -> EXPONENT','arithmetic_operators',1,'p_arithmetic_operators','analizador_sintactico.py',250),
  ('block_expression -> LBRACE expresion RBRACE','block_expression',3,'p_block_expression','analizador_sintactico.py',253),
  ('block_expression -> DO expresion END','block_expression',3,'p_block_expression','analizador_sintactico.py',254),
  ('block_expression -> LBRACE PIPE LOCAL_VARIABLE PIPE expresion RBRACE','block_expression',6,'p_block_expression','analizador_sintactico.py',255),
  ('block_expression -> DO PIPE LOCAL_VARIABLE PIPE expresion END','block_expression',6,'p_block_expression','analizador_sintactico.py',256),
  ('block_assignment -> llamada_metodo block_expression','block_assignment',2,'p_block_assignment','analizador_sintactico.py',259),
  ('proc_expression -> PROC DOT NEW block_expression','proc_expression',4,'p_proc_expression','analizador_sintactico.py',262),
  ('proc_assignment -> LOCAL_VARIABLE ASSIGN proc_expression','proc_assignment',3,'p_proc_assignment','analizador_sintactico.py',265),
  ('proc_call -> LOCAL_VARIABLE DOT CALL LEFT_PAR values RIGHT_PAR','proc_call',6,'p_proc_call','analizador_sintactico.py',268),
  ('proc_call -> LOCAL_VARIABLE DOT LEFT_PAR values RIGHT_PAR','proc_call',5,'p_proc_call','analizador_sintactico.py',269),
  ('proc_call -> LOCAL_VARIABLE LEFT_COR values RIGHT_COR','proc_call',4,'p_proc_call','analizador_sintactico.py',270),
  ('expresion -> condiciones_con_conectores','expresion',1,'p_condition_expr','analizador_sintactico.py',273),
]
